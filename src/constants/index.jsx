export const features = [
  {
    ...
    caption: "Effortless tracking",
    title: "Grow at your own pace",
    text: "With ProgodTivity, forget timers and pressure. Log sessions after they're done, reflect on your progress, and uncover long term patterns. It's like a gentle nudge towards better habits, without the guilt.",
    button: {
  ...
  },
  {
    ...
    caption: "Private & secure",
    title: "Your data, your growth",
    text: "Your privacy is paramount. With anonymized community stats, mutual consent for buddies, and easy data export or deletion, ProgodTivity keeps your information safe and under your control no selling or sharing ever.",
    button: {
...
export const details = [
  {
    ...
    title: "Post-session reflection logging",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Buddy system for mutual support",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Hierarchical pattern analysis",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Motivational milestones & streaks",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to setup ProgodTivity?",
    answer:
      "Setup is simple and quick. Just create an account with your email and password, go through a brief onboarding, and you're ready to log your first session—no complicated configurations needed.",
  },
  {
    id: "1",
    question: "Can I integrate ProgodTivity with other platforms?",
    answer:
      "Currently, ProgodTivity focuses on standalone tracking, but future considerations include integrations with learning platforms like Udemy or Coursera for verified sessions. For now, you can export data in JSON/CSV for manual import elsewhere.",
  },
  {
    id: "2",
    question: "How often do you add new features?",
    answer:
      "We follow a phased rollout: Core MVP at launch, milestones and focus tracking in 2-4 weeks, buddy system in month 2, and mobile app later. Updates are based on user feedback to ensure meaningful improvements.",
  },
  {
    id: "3",
    question: "What is your refund policy?",
    answer:
      "ProgodTivity is free to use with Firebase's generous free tier. There are no subscriptions or payments required initially, so no refunds apply. If we introduce paid features in the future, we'll provide clear policies.",
  },
  {
    id: "4",
    question: "Do you have team or organization plans?",
    answer:
      "Not yet, but it's an open consideration for the future, such as a team mode for educators or companies to track group progress without toxicity.",
  },
  {
    id: "5",
    question: "What happens if I reach storage limits?",
    answer:
      "The free tier supports up to ~50-100 active daily users. If limits are approached, we'll upgrade to Firebase's paid plan seamlessly. Your data remains accessible, and you can always export it.",
  },
  {
    id: "6",
    question: "Can I enable or disable streaks?",
    answer:
      "Yes, streak tracking is optional and defaults to off. You can toggle it in settings anytime without losing data, and broken streaks focus on your longest one positively.",
  },
  {
    id: "7",
    question: "How do I add a buddy?",
    answer:
      "In the Friends tab, enter a friend's email or username to send a request. Both must accept, and you'll see aggregate weekly stats and milestones for mutual support—no individual details unless opted in.",
  },
  {
    id: "8",
    question: "Do you offer tutorials for using the app?",
    answer:
      "The onboarding is brief and intuitive. For more, check our docs or watch the demo. We emphasize ease of use, with positive messaging throughout to guide you.",
  },
  {
    id: "9",
    question: "I’m locked out of my account—what do I do?",
    answer:
      "Use the password reset feature on the login page. If issues persist, contact support via email. We use Firebase Authentication for secure recovery.",
  },
];
export const plans = [
  {
